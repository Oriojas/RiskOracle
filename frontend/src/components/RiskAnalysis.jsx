...
export default function RiskAnalysis({ data }) {
    ...
    return (
        <div className="cyber-panel" style={{ marginTop: '2rem', borderColor: isError ? 'var(--risk-high)' : 'var(--brand-electric)' }}>
            <h2 className="cyber-text" style={{ color: isError ? 'var(--risk-high)' : 'var(--risk-low)', marginBottom: '1.5rem', fontWeight: 700 }}>
                {isError ? 'System Error' : 'Risk Analysis Result'}
            </h2>
